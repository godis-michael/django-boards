...
class LoginRequiredPostUpdateViesTests(PostUpdateViewTestCase):
...
class UnauthorizedPostUpdateViewTests(PostUpdateViewTestCase):
    def setUp(self):
        ...
        username = 'jane'
        password = 'test12345'
        user = User.objects.create_user(username=username, email=username+'mail.com', password=password)
...
class SuccessfulPostUpdateViewTests(PostUpdateViewTestCase):
    ...
    def test_redirection(self):
        posts_url = reverse('boards:topic_posts', kwargs={'board_pk': self.board.pk, 'topic_pk': self.topic.pk})
